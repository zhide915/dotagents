...
Check:
- Third person throughout ("Extracts text…", never "I can help…" or "You can use this…").
...
- Nothing the agent already knows: no explaining what PDFs are, what a library
  is, how to install pip packages in general. Challenge every sentence with
...
Portable across projects, machines, and host agents, and across the models
it will run on.
